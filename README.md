...
**ციფრული ფორმატები ჯერ ნორმალიზდება** — შუალედი, დეფისი, ფრჩხილი და წერტილი შემოწმებამდე იშლება. ამიტომ იჭერს `555 12 34 56`-საც, `(555) 12-34-56`-საც, `+995 555 123456`-საც, `01001 012345`-საც და `4111-1111-1111-1111`-საც, არა მხოლოდ სუფთა ჩანაწერს. ელფოსტასა და IBAN-ს ნორმალიზაცია არ ეხება: იქ წერტილი და შუალედი თავად ფორმატის ნაწილია.
